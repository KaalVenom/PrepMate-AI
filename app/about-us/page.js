    ...
    mission: {
      ...
      content: (
        <div className="space-y-4">
          <p className="text-base md:text-lg">PrepMate AI is on a mission to transform interview preparation by delivering personalized, intelligent AI-driven coaching tailored to your unique career goals.</p>
          <p className="text-base md:text-lg">With PrepMate AI, we aim to close the gap between readiness and achievement, enabling users to confidently reach their full potential.</p>
        </div>
      )
    },
    story: {
      ...
      content: (
        <div className="space-y-4">
          <p className="text-base md:text-lg">The idea for PrepMate AI was inspired by personal experiences with the challenges of interview preparation. As a developer, I set out to create a platform that makes the process easier and empowers individuals to build their confidence.</p>
          <p className="text-base md:text-lg">This journey has been a testament to the strength of passion and innovation, culminating in the creation of a transformative tool for career advancement.</p>
        </div>
      )
    },
    approach: {
      ...
      content: (
        <div className="space-y-4">
          <p className="text-base md:text-lg">PrepMate AI utilizes cutting-edge AI algorithms to create dynamic, contextually tailored interview questions that align with your professional background and aspirations.</p>
          <p className="text-base md:text-lg">With real-time analysis and feedback, the platform offers actionable insights, empowering users to enhance their performance with every mock interview attempt.</p>
        </div>
      )
    }
  }
